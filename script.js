const products = [
    ...
    {id:4,title:"SBI Cashback Credit Card",Sale:'50% to 80% off',cat:'gadget',img:'images/sbicard.png',affiliate:'https://bitli.in/ai7QXrL',discount:'-15%'},
    ...
    {id:9,title:"HSBC Visa Platinum Credit Card",Sale:'50% to 80% off',cat:'finance',img:'images/hsbc.png',affiliate:'https://bitli.in/pKHkJkD',discount:'-20%'},
    {id:10,title:"Axis MyZone Card via BankKaro",Sale:'50% to 80% off',cat:'finance',img:'images/axis bank.png',affiliate:'https://bitli.in/lSbDlTW',discount:'-20%'},
    {id:11,title:"Noise",Sale:'50% to 80% off',cat:'gadgets',img:'images/noise.png',affiliate:'https://bitli.in/WpPRTDp',discount:'-20%'},
    {id:12,title:"IDFC FIRST Bank's FIRSTmoney",Sale:'50% to 80% off',cat:'finance',img:'images/idfc first bank.png',affiliate:'https://bitli.in/2Zwwtgr',discount:'-20%'},
